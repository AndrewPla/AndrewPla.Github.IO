...
feature_text: |
  <h1>Podcast</h1>
  <p>Practical PowerShell conversations for IT pros who want to level up fast.</p>
---

<section class="ap-podcast-page">
  <section class="ap-podcast-hero">
    <p class="ap-podcast-kicker">The PowerShell Podcast</p>
    <h2>Learn from real practitioners, one episode at a time.</h2>
    <p class="ap-podcast-meta">Interviews, practical tactics, and career guidance you can apply right away.</p>
    <p class="ap-podcast-actions">
      <a class="button ap-podcast-btn" href="https://powershellpodcast.podbean.com/">Open on Podbean</a>
  ...
  <section class="ap-podcast-grid">
    <article class="ap-podcast-card">
      ...
      <p class="ap-podcast-meta">Learning PowerShell in 2026 with Tara</p>
      <audio controls preload="none" src="https://mcdn.podbean.com/mf/web/v438wire44266xvi/The_PowerShell_Podcast_episode_214_Tara7qsbv.mp3">
        Your browser does not support audio playback.
      </audio>
      <p><a href="https://powershellpodcast.podbean.com/e/learning-powershell-in-2026-with-tara/">Open episode notes on Podbean</a></p>
    </article>

    <article class="ap-podcast-card">
      <h3>Quick Start Picks (Beginner Friendly)</h3>
  ...
  <section class="ap-podcast-grid">
    ...
    <article class="ap-podcast-card">
      <h3>PowerShell Module: PSPodcast</h3>
      <p class="ap-podcast-meta">Jeff Hicks built <code>PSPodcast</code> so you can explore podcast data directly from PowerShell.</p>
      <pre><code>Install-Module PSPodcast -Scope CurrentUser</code></pre>
      <p><a href="https://github.com/jdhitsolutions/PSPodcast">View PSPodcast on GitHub</a></p>
      <p><a href="https://www.powershellgallery.com/packages/PSPodcast">View PSPodcast on PowerShell Gallery</a></p>
    </article>
  </section>
</section>
